...
const Team = () => {
  return (
    <div  className="flex gap-6 bg-[#121212] p-8 rounded-[8px] border-[#363636] border">
      <div>
        <Image src="/teamImage.png" alt="Team" width={336} height={306} className="object-cover rounded-2xl" quality={100}/>
      </div>
      <div className="flex flex-col justify-center max-w-[576px]">
        ...
        <h3 className="text-2xl font-medium text-[#EEE] py-[10px]">Desenvolvimento de Sites Institucionais, Lading Pages, Aplicativos e Sistemas WEB</h3>
