  ...
  return (
    <section className="flex gap-8">
      <div className="w-[400px] h-[235px] relative flex justify-center items-center">
        <Image src="/background-2.png" alt="About" layout="fill" className="absolute object-cover rounded-[8px]"/>
        <Image src={"/logo.svg"} alt="Polvo" width={142} height={142} className="z-10"/>
      </div>
